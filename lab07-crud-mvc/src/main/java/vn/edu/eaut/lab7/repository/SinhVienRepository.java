...
public class SinhVienRepository {
    ...
    static {
        data.add(new SinhVien(1, "20231619", "Nguyễn Văn Dũng", "dung@gmail.com", "DCCNTT15.10.1"));
    ...
    public List<SinhVien> search(String key) {
        ...
        return data.stream()
                .filter(x -> x.getHoTen().toLowerCase().contains(k) || x.getLop().toLowerCase().contains(k))
